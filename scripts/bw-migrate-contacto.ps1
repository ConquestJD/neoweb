$path = "e:\Proyectos\NeoWeb\src\app\features\contacto\contacto.component.css"
$lines = Get-Content -Path $path -Encoding UTF8

# 0-based index ranges considered "dark background" sections
$darkRanges = @(
  @{start=0; end=404},      # Hero (1-405 in 1-index)
  @{start=1544; end=1968}   # FAQ section (1545-1969 in 1-index)
)
