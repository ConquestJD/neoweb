$path = "e:\Proyectos\NeoWeb\src\app\features\portafolio\portafolio.component.css"
$lines = Get-Content -Path $path -Encoding UTF8

$darkRanges = @(
  @{start=22; end=192},   # Hero (23-193 in 1-index)
  @{start=548; end=627}   # CTA final (549-628 in 1-index)
)
